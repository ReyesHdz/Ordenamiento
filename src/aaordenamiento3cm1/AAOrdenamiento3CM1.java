...
public class AAOrdenamiento3CM1 {
    ...
    public static void main(String[] args) {
        ...
        double [] datos =herramientas.Datos.generarDatosAleatorios(1000, 100);
        ...
        Grafica G = new Grafica("Grafica","t","interacion");
        G.agregarSerie(b1.getTiempos(),"Burbuja");
        G.agregarSerie(b2.getTiempos(),"BurbujaOpt");
